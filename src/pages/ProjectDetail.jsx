...
export function ProjectDetail() {
  ...
  return (
    <div className="flex flex-col items-center p-4 md:p-6 space-y-10 pt-10 md:p-y-20">
      <div className="flex flex-col md:flex-row h-auto md:h-[50vh] w-full gap-6 md:gap-10">
        ...
        <div className="flex-1 flex flex-col items-start gap-6 md:gap-8 justify-center">
          <motion.h1
            ...
            className="text-3xl md:text-5xl lg:text-7xl xl:text-8xl font-bold text-center md:text-left"
          >
            {project.name}
          </motion.h1>
          <div className="flex flex-wrap gap-4 md:gap-5 items-center justify-center md:justify-start">
            <a
              ...
              className={`px-6 md:px-8 py-2 bg-gray-200 rounded-full text-black text-lg md:text-2xl ${!project.links.github ? "text-gray-400 cursor-not-allowed" : ""
                }`}
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`px-6 md:px-8 py-2 bg-gray-200 rounded-full text-black text-lg md:text-2xl ${!project.links.live ? "hidden" : ""
                }`}
